...
final class FDBTerms extends Terms {
    ...
    public FDBTerms(final Transaction txn, final Subspace index, final String fieldName) {
        this.txn = txn;
        this.index = index;
    ...
    public TermsEnum iterator() throws IOException {
        return new FDBTermsEnum(txn, index, fieldName);
    }
    ...
    public long getSumTotalTermFreq() throws IOException {
        ...
        return Utils.getOrDefault(txn, key, 0);
    }
